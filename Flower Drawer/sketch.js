class Flower {
  ...
  move() {
    ...
    if(this.x > width + (this.centerSize/2) + (this.petalLength) & this.vX > 0){
      this.x = 0 - (this.centerSize/2) - (this.petalLength)
    }
    if(this.x < 0 - (this.centerSize/2) - (this.petalLength) && this.vX < 0){
      this.x = width + (this.centerSize/2) + (this.petalLength);
    }
    if(this.y > height + (this.centerSize/2) + (this.petalLength) && this.vY > 0){
      this.y = 0 - (this.centerSize/2) - (this.petalLength)
    }
    if(this.y < 0 - (this.centerSize/2) - (this.petalLength) && this.vY < 0){
      this.y = height + (this.centerSize/2) + (this.petalLength);
    }
  }
}
